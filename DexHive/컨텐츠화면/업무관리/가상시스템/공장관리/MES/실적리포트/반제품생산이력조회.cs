...
{
    public partial class 반제품생산이력조회 : 스크린 ,I스크린
    {
        public 반제품생산이력표_모델 그리드모델 { get; set; }
        public 반제품생산이력검색_모델 검색조건모델 { get; set; }
        ...
        private void 반제품생산이력조회_Shown(object sender, EventArgs e)
        {
            그리드초기화();
            그리드상세초기화();
            콤보박스초기화();
        ...
        private void 그리드초기화()
        {
            ...
            컬럼들[3] = new DexGridColumn();
            컬럼들[3].컬럼명 = "PRODUCTDEFINITIONIDLTYPE";
            컬럼들[3].헤더명 = "제품코드";
            컬럼들[3].너비 = 100;
        ...
        {
            그리드모델 = new 반제품생산이력표_모델();
            그리드모델.그리드 = this.반제품생산이력표_모델;
            그리드모델.그리드상세 = this.반제품생산이력표_모델2;
            그리드모델.그리드.기본테이블명 = "CIM_PRODUCTORDER";

            검색조건모델 = new 반제품생산이력검색_모델();
            ...
            검색조건모델.생산LOT = this.생산LOTTB;
            검색조건모델.생산LOT2 = this.생산LOTTB2;
