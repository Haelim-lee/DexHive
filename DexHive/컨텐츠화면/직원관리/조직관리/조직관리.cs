...
{
    public partial class 조직관리 : 스크린, I스크린
    {
        public 조직관리표_모델 그리드모델 {get;set;}
        ...
        public void 행추가()
        {
            if (조직관리표.DataSource == null) 조회();
            {
                ((DataTable)조직관리표.DataSource).Rows.Add();
            }
        }

        public void 행제거()
        {
            if (조직관리표.CurrentRow != null)
                if ((DataRowView)조직관리표.CurrentRow.DataBoundItem != null)
                {
                    bool a = 조직관리표.CurrentRow.IsNewRow;
                    DataRow DR = ((DataRowView)조직관리표.CurrentRow.DataBoundItem).Row;
                    조직관리표.Rows.Remove(조직관리표.CurrentRow);
